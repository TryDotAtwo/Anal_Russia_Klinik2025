...
## Почему мы проверяем клинреки: конкретные примеры

**Акупунктура в онкологических клинреках с уровнем B1, хондроитин и глюкозамин с A1 — примеры, из-за которых появился этот проект.**

| Что обнаружено | Клинрекомендация и цель назначения | УУР / УДД |
|---|---|---|
| **Акупунктура, включая электро-, лазеро- и другие варианты пунктуры** | [Рак пищевода и кардии, 237_6](https://cr.minzdrav.gov.ru/view-cr/237_6): ускорение восстановления моторики пищеварительного тракта | **B / 1** |
| **Акупунктура** | [Злокачественные новообразования полости рта, 164_2](https://cr.minzdrav.gov.ru/view-cr/164_2): коррекция сухости во рту на фоне лучевой терапии головы и шеи | **B / 1** |
| **Акупунктура названа эффективной при вазомоторных симптомах** | [Менопауза и климактерическое состояние у женщины, 117_2](https://cr.minzdrav.gov.ru/view-cr/117_2): комментарий к общей рекомендации о негормональных методах | **A / 1 у общей рекомендации** |
| **Хондроитин, глюкозамин и их комбинации** | [Коксартроз, 870_1](https://cr.minzdrav.gov.ru/view-cr/870_1): облегчение симптомов и заявленный структурно-модифицирующий эффект | **A / 1** |

## Что найдено

**488 клинических рекомендаций · 5 688 оценённых упоминаний · 3 088 упоминаний, классифицированных как рекомендации.**

Результаты сохранённого прогона от 5 мая 2026 года:
...
Это количество упоминаний, а не уникальных препаратов. Классы определены LLM; 3 088 находок не означают 3 088 доказанных медицинских ошибок. `error` — ложное или нерелевантное словарное совпадение.

УУР — уровень убедительности рекомендаций, УДД — уровень достоверности доказательств. В онкологических примерах речь о реабилитации и симптомах, не о противоопухолевом лечении. Уровни сверены с текстами версий из сохранённого корпуса; это повод для предметного разбора обоснований, а не самостоятельный вывод о неэффективности каждого метода.

[Цитаты, контекст и идентификаторы найденных случаев →](Bot_for_anal_rec/docs/highlighted-cases.md)
...
## Словарные источники и файлы результатов
